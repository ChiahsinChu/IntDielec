...
from toolbox.io.cp2k import Cp2kCube
from toolbox.utils import *
from toolbox.utils.unit import *
from toolbox.utils.utils import load_dict, save_dict
...
class WaterMLWF:
    ...
    def run(self):
        ...
        self.results = {"dipole": np.array(dipole), "z": np.array(z)}
...
class DFTInvEps:
    ...
    def read_data_cube(self, fname):
        ...
        np.save(
            os.path.join(os.path.dirname(fname), "totden.npy"), [output[0], output[1]]
        )
