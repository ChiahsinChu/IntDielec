...
class TestInverseDielectricConstant(DielectricPlanar):
    ...
    def __init__(self, atomgroups, surf_ids, img_plane=0.0, **kwargs) -> None:
    ...
    def _conclude(self):
        ...
        volume = self._obs.bin_area * (np.abs(z_hi - z_lo) - 2 * self.img_plane)
        self.new_results = {
            "z_lo": z_lo,
        ...
        pref /= constants.angstrom / (constants.elementary_charge) ** 2
